...
#define STRING_CONFIG_H_AUTHOR "(printedsolid.com + Zach for I3D)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hemera CR-10S"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Cr10s Stock Bed- 12v
  #define DEFAULT_bedKp 185.57
  #define DEFAULT_bedKi 35.40
  #define DEFAULT_bedKd 648.5
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 63.5, 5, 0 }
...
#define Y_MIN_POS -20
#define Z_MIN_POS 0
#define X_MAX_POS 330 // 15mm Extra space on the right end
#define Y_MAX_POS 320 // 4mm Extra space behind the bed
